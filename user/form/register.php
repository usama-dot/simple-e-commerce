        ...
        <div class="row">
            <div class="col-md-4  m-auto mt-5 bg-white">
                <form action="register1.php" method="post" class = "p-4">
                    <h2 class = "text-warning font-monospace mb-4 text-center">Register Account</h2>
                    ...
                    <div class="form-outline mb-3">
                      ...
                      <div class="form-outline mb-3">
                        ...
                        <button class = "form-control btn btn-danger fs-5 fw-bold" name="register_account">Register</button>
